...
our $CONFIG = {
  ...
  desktop_files_paths       => ["/usr/share/applications", '/home/swampyx/Desktop'],
  editor                    => "geany",
  gtk_rc_filename           => undef,
  icon_dirs_first           => undef,
  icon_dirs_last            => ["/usr/share/icons"],
  icon_dirs_second          => undef,
  missing_icon              => "gtk-missing-image",
  skip_app_command_re       => undef,
  skip_app_name_re          => undef,
  skip_file_content_re      => undef,
  skip_file_name_re         => qr{^(?>avahi|sakura|pcmanfm|dconf|b(?>vnc|ssh)|gconf)},
  skip_svg_icons            => 1,
  terminal                  => "sakura",
  use_only_my_icon_dirs     => 0,
  VERSION                   => 0.54,
  wine_desktop_files_paths  => ["/home/swampyx/.local/share/applications/wine"],
